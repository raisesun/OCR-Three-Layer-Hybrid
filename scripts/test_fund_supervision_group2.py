...
def main():
    ...
    # 选择第4和第5个案例进行测试
    case_dirs = sorted([d for d in sample_dir.iterdir() if d.is_dir()])[3:5]

    print("资金监管文档测试 - 第2组数据")
    ...
    # 保存结果
    output_file = Path('/Users/dongsun/Github/OCR-Three-Layer-Hybrid/tests/fund_supervision_test_results_group2.json')
