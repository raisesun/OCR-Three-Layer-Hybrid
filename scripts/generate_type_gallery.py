...
TYPE_GROUPS = {
    "身份证": ["身份证", "身份证-正面", "身份证-背面"],
    "户口本": ["户口本", "户口本-首页", "户口本-个人页"],
    "结婚证": ["结婚证", "结婚证-封面", "结婚证-内容页", "结婚证-盖章页"],
    "离婚证": ["离婚证", "离婚证-封面", "离婚证-内容页", "离婚证-盖章页"],
    "不动产权证书": [
        "不动产权证书",
        "不动产权证书-首页",
        "不动产权证书-内容页",
    ...
    "发票": ["发票"],
    "购房合同": ["购房合同", "购房合同-首页", "购房合同-内容页", "购房合同-签署页"],
    "存量房合同": ["存量房合同", "存量房合同-首页", "存量房合同-内容页", "存量房合同-签署页"],
    "离婚协议书": ["离婚协议书"],
    "资金监管协议": [
        "资金监管协议",
        "资金监管协议-首页",
